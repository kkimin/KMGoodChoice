...
protocol AllHomeInteractable: Interactable, TransportHomeListener {
  var router: AllHomeRouting? { get set }
  var listener: AllHomeListener? { get set }
}

protocol AllHomeViewControllable: ViewControllable {

}

final class AllHomeRouter: ViewableRouter<AllHomeInteractable, AllHomeViewControllable>, AllHomeRouting {
  ...
  init(
    interactor: AllHomeInteractable,
    viewController: AllHomeViewControllable,
